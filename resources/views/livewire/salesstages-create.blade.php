                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="">
                        ...
                        <div class="mb-4">
                            ...
                            <label for="stage"
                                class="block text-gray-700 text-sm font-bold mb-2">Sales Stage:</label>
                            ...
                            <input type="text"
                                ...
                                @error('stage') <span class="text-red-500"></span>@enderror
                        ...
                        <!-- <div class="mb-4">
                            ...
                            <label for="seq"
                                class="block text-gray-700 text-sm font-bold mb-2">Sequence:</label>
                            ...
                            <input type="number"
                                ...
                                @error('seq') <span class="text-red-500"></span>@enderror
