          ...
          <div class="flex">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
              ...
              <jet-nav-link
                ...
                :active="$page.currentRouteName == 'account.index'" >Accounts
              </jet-nav-link>
            <!-- <inertia-link :href="route('account.index')" class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out" :active="$page.currentRouteName == 'account'" >Accounts</inertia-link> -->
                 <jet-nav-link
                :href="route('contact.index')"
                :active="$page.currentRouteName == 'contact.index'" >Accounts
              </jet-nav-link>
             <!-- <inertia-link :href="route('contact.index')" class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out"  >Contacts</inertia-link>-->
            </div>
          </div>
